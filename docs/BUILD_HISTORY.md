...
|---|---:|---|---|---|---|---|
<!-- NEXT_BUILD_ROW -->
| 1.0.4 | 13 | 2026-08-04 | Critical Fix | App otomatis pause dan seluruh audio berhenti saat masuk background; musik hanya lanjut setelah tombol play ditekan | Closed Testing (in review) | `d08a56b` |
